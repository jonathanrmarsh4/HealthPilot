...
- **Premium Theme System v2.0 - Dual-Personality Liquid Glass Design (Nov 2025):** Admin-controlled visual theme with distinct light/dark mode aesthetics. **Light Mode:** Desaturated coral (#FFB4AF) → pink (#F0BFDC) → teal (#80E5E5) gradient with clean white base (#FFFFFF) and 15% opacity overlay for subtle, airy elegance. Cards at 85-90% opacity for readability. **Dark Mode:** Original saturated gradient (#FF7C77 → #E58AC9 → #00CFCF) with very dark blue-black base (#0A0F14) and dramatic glass morphism. Glass surfaces at rgba(16,23,36,0.55) for futuristic, data-driven aesthetic. Borders: rgba(255,255,255,0.12), inner sheen: rgba(255,255,255,0.08), teal glow: rgba(0,207,207,0.22), shadows: 0 8px 28px rgba(0,0,0,0.35). Typography: pure white (#FFFFFF) primary, #C6D0DE secondary. Complete design system includes: (1) CSS variables for dual-mode brand colors, glass effects, shadows, and SF Pro typography, (2) Mode-specific base colors with tailored gradient overlays, (3) Liquid Glass component (.hp-glass) with frosted blur and dual-border system (::before for outer hairline, ::after for inner sheen), (4) Premium buttons (.hp-btn-primary, .hp-btn-ghost) with gradient backgrounds and hover lift effects, (5) Glass cards, tiles, and chips with mode-specific opacity, (6) Fluid responsive typography (.h1, .h2) using clamp() sizing, (7) Vibrant chart colors for dark mode (#00CFCF, #FF7C77, #E58AC9), status colors (#4AE3C6 success, #FF9B8E warning, #93C5FD info). Theme persists across all pages using premium-theme class on html/body elements. Controlled via Admin Panel CMS Theme tab with real-time toggle. Architecture: landing_page_content.premium_theme_enabled database field, GET/PUT API endpoints, PremiumThemeProvider component applying premium-theme class, explicit utility classes (.hp-*) scoped to .premium-theme namespace.
